  ...
  <ebook-dialog :title="title" ref="dialog">
    <div class="dialog-list-wrapper" v-if="!ifNewGroup">
      <div class="dialog-list-item"
           ...
           v-show="((item.edit === 2 && isInGroup) || item.edit !== 2 || !item.edit) && item.title !== shelfCategory.title">
    ...
    <div class="dialog-new-group-wrapper" v-else>
      ...
      <div class="dialog-input-wrapper">
        <div class="dialog-input-inner-wrapper">
          <input type="text" class="dialog-input" v-model.trim="newGroupName" ref="dialogInput">
    ...
    <div slot="btn" class="group-dialog-btn-wrapper">
      ...
      <div class="dialog-btn" @click="createNewGroup" :class="{'is-empty': !newGroupName || newGroupName.length < 1}"
    ...
    methods: {
      ...
      onGroupClick(item) {
        if (item.edit && item.edit === 1) {
          ...
          this.moveOutFromGroup(this.shelfSelected, () => {
            this.onComplete()
